...
public abstract class PlayerNodeEvaluator {
    protected PathNavigationRegion level;
    protected Player mob;
    ...
    public abstract BlockPathTypes getBlockPathType(BlockGetter pLevel, int pX, int pY, int pZ, Player pMob);
