...
public class PlayerPathFinder {
    ...
    public PlayerPathFinder(PlayerNodeEvaluator pNodeEvaluator, int pMaxVisitedNodes) {
     ...
     */
    @Nullable
    public Path findPath(PathNavigationRegion pRegion, Player pMob, Set<BlockPos> pTargetPositions, float pMaxRange, int pAccuracy, float pSearchDepthMultiplier) {
        this.openSet.clear();
